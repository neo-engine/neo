...
namespace SOUND::SSEQ {
    ...
    // table below is different as a result Table manually obtained in 5 hours (more or less),
    // through a quickly-made homebrew program :P
    const u16 PITCH_TABLE[ PITCH_TABLE_SIZE ] = {
        // clang-format off
