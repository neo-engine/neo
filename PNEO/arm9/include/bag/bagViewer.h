...
namespace BAG {
    class bagViewer {
      ...
      private:
        ...
        std::vector<std::pair<std::pair<u16, u16>, itemData>> _view;
        ...
        std::vector<choice> getItemChoices( u16 p_itemId, itemData* p_data );

        u8 confirmChoice( u16 p_targetItem, itemData* p_data );

        inline std::pair<std::pair<u16, u16>, itemData> currentItem( ) const {
         ...
         */
        bool useItemOnPkmn( pokemon& p_pokemon, u16 p_item, itemData* p_data );
