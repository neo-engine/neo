...
namespace DEX {
    ...
    constexpr u16 LOCAL_DEX_SIZE = 253;
    constexpr u8  MAX_PAGES      = 3;

    constexpr u16 MAX_LOCAL_DEX_PAGES = 126;
    ...
    constexpr u16 LOCAL_DEX[ LOCAL_DEX_SIZE ] = {
        ...
        // dirty stuff
        PKMN_GULPIN, PKMN_SWALOT, PKMN_GRIMER, PKMN_MUK, PKMN_KOFFING, PKMN_WEEZING, PKMN_KECLEON,

        // beach
        PKMN_CORPHISH, PKMN_CRAWDAUNT, PKMN_SANDYGAST, PKMN_PALOSSAND, PKMN_STARYU, PKMN_STARMIE,

        // hail and sand
        PKMN_SPHEAL, PKMN_SEALEO, PKMN_WALREIN, PKMN_SNORUNT, PKMN_GLALIE, PKMN_FROSLASS,
        PKMN_SANDSHREW, PKMN_SANDSLASH, PKMN_SNOM, PKMN_FROSMOTH, PKMN_BALTOY, PKMN_CLAYDOL,
        PKMN_TRAPINCH, PKMN_VIBRAVA, PKMN_FLYGON,

        // spooky
        PKMN_SHUPPET, PKMN_BANETTE, PKMN_DUSKULL, PKMN_DUSCLOPS, PKMN_DUSKNOIR, PKMN_LITWICK,
        PKMN_LAMPENT, PKMN_CHANDELURE, PKMN_MISDREAVUS, PKMN_MISMAGIUS, PKMN_MURKROW,
