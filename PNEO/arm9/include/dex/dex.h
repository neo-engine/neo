...
namespace DEX {
    ...
    constexpr u16 LOCAL_DEX_SIZE = 280;
    constexpr u8  MAX_PAGES      = 3;

    constexpr u16 MAX_LOCAL_DEX_PAGES = 138;
    ...
    constexpr u16 LOCAL_DEX[ LOCAL_DEX_SIZE ] = {
        ...
        PKMN_FROSMOTH, PKMN_SNEASEL, PKMN_WEAVILE, PKMN_SNEASLER, PKMN_GLIGAR, PKMN_GLISCOR,
        PKMN_SANDSHREW, PKMN_SANDSLASH, PKMN_BALTOY, PKMN_CLAYDOL, PKMN_TRAPINCH, PKMN_VIBRAVA,
        PKMN_FLYGON,
