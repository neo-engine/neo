...
namespace DEX {
    ...
    constexpr u16 LOCAL_DEX_SIZE = 316;
    constexpr u8  MAX_PAGES      = 3;

    constexpr u16 MAX_LOCAL_DEX_PAGES = 153;
    ...
    constexpr u16 LOCAL_DEX[ LOCAL_DEX_SIZE ] = {
        ...
        PKMN_LOUDRED, PKMN_EXPLOUD, PKMN_ZANGOOSE, PKMN_SEVIPER, PKMN_BUNEARY, PKMN_LOPUNNY,
        ...
        PKMN_PINECO, PKMN_FORRETRESS, PKMN_PINSIR, PKMN_HERACROSS, PKMN_LARVESTA, PKMN_VOLCARONA,
        ...
        PKMN_GOLDUCK, PKMN_SHELLOS, PKMN_GASTRODON,
        ...
        PKMN_MAKUHITA, PKMN_HARIYAMA, PKMN_MACHOP, PKMN_MACHOKE, PKMN_MACHAMP, PKMN_MANKEY,
        PKMN_PRIMEAPE, PKMN_ANNIHILAPE, PKMN_MEDITITE, PKMN_MEDICHAM, PKMN_CRABRAWLER,
        PKMN_CRABOMINABLE, PKMN_RIOLU, PKMN_LUCARIO,

        // ocean
        PKMN_TENTACOOL, PKMN_TENTACRUEL, PKMN_CARVANHA, PKMN_SHARPEDO, PKMN_HORSEA, PKMN_SEADRA,
        PKMN_KINGDRA, PKMN_REMORAID, PKMN_OCTILLERY,
        ...
        PKMN_RAICHU, PKMN_JOLTIK, PKMN_GALVANTULA, PKMN_SPINDA,

        // burning stuff
        PKMN_NUMEL, PKMN_CAMERUPT, PKMN_SLUGMA, PKMN_MAGCARGO, PKMN_TORKOAL, PKMN_PONYTA,
        PKMN_RAPIDASH, PKMN_VULPIX, PKMN_NINETALES, PKMN_TURTONATOR,

        // dirty stuff
        PKMN_GULPIN, PKMN_SWALOT, PKMN_GRIMER, PKMN_MUK, PKMN_KOFFING, PKMN_WEEZING, PKMN_TRUBBISH,
        PKMN_GARBODOR, PKMN_KECLEON, PKMN_DITTO,

        // Eevee
        PKMN_EEVEE, PKMN_VAPOREON, PKMN_JOLTEON, PKMN_FLAREON, PKMN_ESPEON, PKMN_UMBREON,
        PKMN_LEAFEON, PKMN_GLACEON, PKMN_SYLVEON,
        ...
        // hail and sand
        PKMN_SPHEAL, PKMN_SEALEO, PKMN_WALREIN, PKMN_SEEL, PKMN_DEWGONG, PKMN_SNORUNT, PKMN_GLALIE,
        PKMN_FROSLASS, PKMN_SNOM, PKMN_FROSMOTH, PKMN_SNEASEL, PKMN_WEAVILE, PKMN_SNEASLER,
        PKMN_GLIGAR, PKMN_GLISCOR, PKMN_SANDSHREW, PKMN_SANDSLASH, PKMN_BALTOY, PKMN_CLAYDOL,
        ...
        PKMN_DOUBLADE, PKMN_AEGISLASH, PKMN_CASTFORM,
    ...
    constexpr u16 LOCAL_DEX_PAGES[ MAX_LOCAL_DEX_PAGES ][ MAX_LOCAL_DEX_SLOTS ] = {
        ...
        // EEVEE
        { PKMN_EEVEE, PKMN_VAPOREON, PKMN_JOLTEON },
        { PKMN_FLAREON, PKMN_ESPEON, PKMN_UMBREON },
        { PKMN_LEAFEON, PKMN_GLACEON, PKMN_SYLVEON },
        ...
        { EMPTY, PKMN_ABSOL },
        { PKMN_NATU, PKMN_XATU },
        { PKMN_PAWNIARD, PKMN_BISHARP, PKMN_KINGAMBIT },
        { PKMN_BRONZOR, PKMN_BRONZONG },
        { PKMN_HONEDGE, PKMN_DOUBLADE, PKMN_AEGISLASH },
        { EMPTY, PKMN_CASTFORM },
