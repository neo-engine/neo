...
ability abilities[ 180 ] = {
    ability( "Energieaufladung", "Sch\x81""tzt vor L\x84""rmmoveen.", 1 ),
    ability( "Duftnote", "Macht Begegnungen mit wilden\nPKMN unwahrscheinlicher.", 8 ),
    ability( "Niesel", "Betritt das pokemon den Kampf,\nbeginntes zu regnen.", 18 ),
    ability( "Temposchub", "Erh\x94""ht im Kampf kontinuierlich\ndie Initiative.", 32 ),
    ability( "Kampfpanzer", "Sch\x81""tzt vor Volltreffern.", 1 ),
    ability( "Robustheit", "Sch\x81""tzt vor K.O.-Attacken.", 1 ),
    ability( "Feuchtigkeit", "Verhindert Selbstzerst\x94""rung\nvon pokemon im Kampf.", 1 ),
    ability( "Flexibilit\x84""t", "Sch\x81""tzt vor Paralyse.", 1 ),
    ability( "Sandschleier", "Macht Fehlschlag gegn.\nAttacken im Sandsturm wahr-\nscheinlicher.", 1 ),
    ability( "Statik", "Paralysiert bei Ber\x81""hrung.", 1 ),
    ability( "Volt-Absorber", "Wandelt Schaden von\x9e\x9f\xa0\xa1\nAttacken in KP um.", 1 ),
    ability( "H2O-Absorber", "Wandelt Schaden\nvon\x89\x8a\x8b\x8c\nAttacken in KP um.", 1 ),
    ability( "D\x94""sigkeit", "Sch\x81""tzt vor Anziehung.", 1 ),
    ability( "Wolke Sieben", "Sch\x81""tzt vor Wetter-Effekten.", 1 ),
    ability( "Facettenauge", "Macht Treffer eigener Attacken\nwahrscheinlicher.", 1 ),
    ability( "Insomnia", "Sch\x81""tzt vor Schlaf.", 1 ),
    ability( "Farbwechsel", "Passt eigenen Typ der letzten\ngegn. Attacke an.", 32 ),
    ability( "Immunit\x84""t", "Sch\x81""tzt vor Vergiftung.", 1 ),
    ability( "Feuerf\x84""nger", "Verst\x84""rkt eigene \x85\x86\x87\x88 Attacken nach Treffer gegn.\n\x85\x86\x87\x88 Atttacke.", 1 ),
    ability( "Puderabwehr", "Sch\x81""tzt vor Zusatzeffekten\ngegn. Attacken.", 1 ),
    ability( "Tempomacher", "Sch\x81""tzt vor Verwirrung.", 1 ),
    ability( "Saugnapf", "Sch\x81""tzt vor ungewolltem\nAustausch.", 1 ),
    ability( "Bedroher", "Betritt das pokemon den Kampf,\nwird der gegn. Angriff\nverringert.", 2 ),
    ability( "Wegsperre", "Verhindert Austausch oder\nFluchtgegn. pokemon.", 16 ),
    ability( "Rauhaut", "Schadet gegn. pokemon""nach direktem\nTreffer.", 32 ),
    ability( "Wunderwache", "Nur sehr effektive""Attacken k\x94""nnen\nSchaden zuf\x81""gen.", 1 ),
    ability( "Schwebe", "Sch\x81""tzt vor\n\xd2\xd3\xd4\xd5 Attacken.", 1 ),
    ability( "Sporenwirt", "Verursacht evtl.\nSp. Zustand bei\ngegn. pokemon nach\ndirektem Treffer.", 32 ),
    ability( "Synchro", "Gibt Sp. Zustand\nan gegn. pokemon\nweiter.", 32 ),
    ability( "Neutraltorso", "Sch\x81""tzt vor\nStatusver\x84""nd.", 1 ),
    ability( "Innere Kraft", "Sch\x81""tzt vor\nStatusver\x84""nd.", 1 ),
    ability( "Blitzf\x84""nger", "Sch\x81""tzt vor\n\x9e\x9f\xa0\xa1 Attacken.", 1 ),
    ability( "Edelmut", "Macht Zusatz-\neffekte von eig.\nAttacken wahr-\nscheinlicher.", 1 ),
    ability( "Wassertempo", "Erh\x94""ht eigene\nInitiative bei\nRegen.", 16 ),
    ability( "Chlorophyll", "Erh\x94""ht eigene\nInitiative bei\nstarkem Sonnen-\nschein.", 16 ),
    ability( "Erleuchtung", "Macht Begegnungen\nmit wilden pokemon\nwahrscheinlicher.", 8 ),
    ability( "F\x84""hrte", "Kopiert die F\x84""hig-\nkeit eines gegn.\nPKMN.", 2 ),
    ability( "Kraftkollos", "Erh\x94""ht eigenen\nAngriff.", 8 ),
    ability( "Giftdorn", "Vergiftet bei\nBer\x81""hrung.", 32 ),
    ability( "Konzentrator", "Sch\x81""tzt vor\nZur\x81""ckschrecken.", 1 ),
    ability( "Magmapanzer", "Sch\x81""tzt vor\nEinfrieren.\nBeschleunigt Brut-vorg\x84""nge.", 9 ),
    ability( "Aquah\x81""lle", "Sch\x81""tzt vor\nVerbrennungen.", 1 ),
    ability( "Magnetfalle", "Verhindert Flucht\noder Austausch von""gegn. \xb2\xb3\xb4\xb5 pokemon.", 16 ),
    ability( "L\x84""rmschutz", "Sch\x81""tzt vor L\x84""rmmoveen.", 1 ),
    ability( "Regengenuss", "Regeneriert KP bei Regen.", 16 ),
    ability( "Sandsturm", "Betritt das pokemon den Kampf, so tritt ein Sandsturm auf.", 16 ),
    ability( "Erzwinger", "Gegn. pokemon verbrauchen 2AP pro erfolgreicher Attacke.", 32 ),
    ...
    ability( "Angsthase", "Garantiert das Entkommen von wilden pokemon.", 16 ),
    ...
    ability( "Schnarchnase", "pokemon kann nicht in zwei aufeinanderfolgenden Z\x81""gen angreifen.", 16 ),
    ability( "\x9A""bereifer", "Erh\x94""ht Angriff, senkt Genauigkeit.", 8 ),
    ability( "Charmebolzen", "Bet\x94""rt bei Kontakt.", 32 ),
    ability( "Plus", "Erh\x94""ht Sp. Angriff sofern ein pokemon mit Minus am Kampf teilnimmt.", 1 ),
    ability( "Minus", "Erh\x94""ht Sp. Angriff sofern ein pokemon mit Plus am Kampf teilnimmt.", 1 ),
    ...
    ability( "Expidermis", "pokemon heilt evtl. eigene Sp. Zust\x84""nde.", 16 ),
    ...
    ability( "Kloakenso\x9D""e", "Schadet Anwendern von Saugmoveen.", 32 ),
    ...
    ability( "D\x81""rre", "Betritt das pokemon den Kampf, intensiviert sich die Sonneneinstrahlung.", 16 ),
    ability( "Ausweglos", "Verhindert Austausch oder Flucht gegn. pokemon.", 16 ),
    ...
    //GEN 4
    ability( "Fu\x9D""angel", "Ist das pokemon verwirrt, sind Treffer gegn. pokemon unwahrscheinlicher.", 1 ),
    ...
    ability( "Felsenfest", "Erh\x94""ht eigene Initiative, wenn das pokemon zur\x81""ckschreckt.", 32 ),
    ability( "Schneemantel", "Macht Fehlschlag gegn. Attacken bei Hagel wahrscheinlicher.", 1 ),
    ability( "V\x94""llerei", "Das pokemon benutzt Beeren fr\x81""hzeitig.", 32 ),
    ...
    ability( "Download", "Passt Statuswerte entsprechend denen gegn. pokemon an.", 16 ),
    ...
    ability( "Rasanz", "Erh\x94""ht Initiative wenn das pokemon von einem Sp. Zustand betroffen ist.", 1 ),
    ability( "Regulierung", "Alle Attacken des pokemon werden zu NORMAL-Attacken.", 1 ),
    ability( "Supersch\x81""tze", "Steigert Attacken nach Volltreffern.", 1 ),
    ability( "Magieschild", "Nur physische Attacken schaden dem pokemon.", 1 ),
    ability( "Schildlos", "Alle Attacken treffen garantiert.", 1 ),
    ability( "Zeitspiel", "Das pokemon agiert stets zuletzt.", 16 ),
    ...
    ability( "Tollpatsch", "Das pokemon kann keine Items verwenden.", 16 ),
    ...
    ability( "Finalschlag", "Schadet dem pokemon, das finale Attacke landet.", 32 ),
    ability( "Vorahnung", "Ahnt gef\x84""hrliche Attacke eines gegn. pokemon.", 2 ),
    ability( "Vorwarnung", "Ahnt st\x84""rkste Attacke eines gegn. pokemon.", 2 ),
    ...
    ability( "Rauflust", "Erm\x94""glicht gegnerischen \x95\x96\x97\x98""-pokemon zu schaden.", 1 ),
    ...
    ability( "Hagelalarm", "Betritt das pokemon den Kampf, beginnt es zu hageln.", 16 ),
    ability( "Honigmaul", "Das pokemon sammelt von Zeit zu Zeit Honig.", 8 ),
    ability( "Schnüffler", "Erkennt Items gegnerischer pokemon.", 16 ),
    ability( "Achtlos", "Verst\x84""rkt Attacken mit R\x81""cksto\x9D"".", 1 ),
    ability( "Variabilit\x84""t", "Passt Typ der getragenen Tafel an.", 8 ),
    ability( "Pflanzengabe", "Steigert Effektivit\x84""t von Team-pokemon bei Sonne.", 1 ),
    ability( "Alptraum", "Schadet schlafenden gegnerischen pokemon.", 1 ),
    //Gen 5
    ...
    ability( "Heilherz", "Heilt Statusprobleme von pokemon im Team.", 1 ),
    ability( "Freundeshut", "Weniger Schaden bei pokemon im Team.", 1 ),
    ...
    ability( "Telepathie", "Immun gegen Attaken von pokemon im Team.", 1 ),
    ...
    ability( "Illusion", "Nimmt Gestalt des letzten pokemon im Team an.", 2 ),
    ...
    ability( "Hochmut", "Erh\x94""ht Angriff, wenn gegn. pokemon besiegt.", 1 ),
    ...
    ability( "Triumphstern", "Erh\x94""ht Genauigkeit von Attacken von pokemon im Team.", 1 ),
    ...
    //Gen *
    ability( "Klon", "Das pokemon kann sich weder entwickeln, noch kann es TM oder VM erlernen.", 1 ),
    ...
    ability( "Schillerschuppe", "Macht Begegnungen mit schillernden pokemon wahrscheinlicher.", 8 ),
    ability( "Nebelwand", "Betritt das pokemon den Kampf, zieht starker Nebel auf.", 16 ),
    ability( "K\x94""nigsheiler", "Heilt alle pokemon im Team am Ende einer Runde ein wenig.", 1 ),
    ability( "Einsch\x91""chterer", "Betritt das pokemon den Kampf, tauscht der Gegner sein pokemon aus.", 1 ),
    ability( "Effizienz", "Verdoppelt Schw\x84""en und Resistenzen.", 1 ),
    ability( "\x9A""berfluss", "Verbraucht keine AP.", 1 )
};

/*	Ability:Cloned
Cloned pokemon can neither evolve nor use TMs
