...
ribbon RibbonList[ MAX_RIBBONS ] = {
    ...
    { "Band der Schönheit", "Sieger in der Normal-Klasse!" },
    { "Band der Schönheit Super", "Sieger in der Super-Klasse!" },
    { "Band der Schönheit Hyper", "Sieger in der Hyper-Klasse!" },
    { "Band der Schönheit Master", "Sieger in der Master-Klasse!" },
    ...
    //0x3e
    { "Band der Stärke", "Sieger in der Normal-Klasse!" },
    { "Band der Stärke Super", "Sieger in der Super-Klasse!" },
    { "Band der Stärke Hyper", "Sieger in der Hyper-Klasse!" },
    { "Band der Stärke Master", "Sieger in der Master-Klasse!" },
    ...
    { "Band des Landes", "Pokémon Liga Band des Champs" },
    { "Band des Nation", "Band für den erfolgreichen Abschluss aller Schwierigkeitsgrade." },
    { "Band der Erde", "100. Sieg in Folge Gedenk-Band" },
    { "Band der Welt", "Pokémon Liga Band des Champs" },
    ...
    { "Band der Sorglosigkeit", "Ein Band zur Erinnerung an einen Fehler, der zu lebenswichtigen Entscheidungen führte." },
    ...
    { "Band der Schönheit", "Sieger in der Normal-Klasse in Sinnoh!" },
    { "Band der Schönheit Mega", "Sieger in der Mega-Klasse in Sinnoh!" },
    { "Band der Schönheit Ultra", "Sieger in der Ultra-Klasse in Sinnoh!" },
    { "Band der Schönheit Master", "Sieger in der Master-Klasse in Sinnoh!" },
    ...
    //0x62
    { "Band der Stärke", "Sieger in der Normal-Klasse in Sinnoh!" },
    { "Band der Stärke Mega", "Sieger in der Mega-Klasse in Sinnoh!" },
    { "Band der Stärke Ultra", "Sieger in der Ultra-Klasse in Sinnoh!" },
    { "Band der Stärke Master", "Sieger in der Master-Klasse in Sinnoh!" },
