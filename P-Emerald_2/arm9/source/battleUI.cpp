...
#define REDRAW 9
    ...
    void drawPkmnConfirmation( pokemon p_pokemon, bool p_alreadySent, bool p_alreadyChosen, u8 p_x,
        ...
        if( !( p_pokemon.m_boxdata.m_individualValues.m_isEgg ) ) {
            ...
            IO::regularFont->printString( p_pokemon.m_boxdata.m_name, p_x + dx + 58, dy + 66, true,
                                          IO::font::CENTER );
                ...
                if( !p_alreadySent && !p_alreadyChosen && !dead
                    ...
                    loop( ) {
                        ...
                        if( !IN_RANGE_R( x, y, x + 128, y + 64 ) ) {
                            drawPkmnConfirmation( p_pokemon, p_alreadySent, p_alreadyChosen, x, y,
                                                  false );
                            break;
                        }
                    }
    ...
    if( p_val == 1.1 )                         \
        ...
        IO::boldFont->setColor( BLACK_IDX, 2 );
                ...
                IO::printRectangle( (u8) 158, (u8) 18,
                                    ...
                                    u8( 18 + 6 ), true, false, GRAY_IDX );
                IO::printRectangle(
                    (u8) 158, u8( 18 + 6 ),
                    u8( 158 + ( 68.0 * p_pokemon.m_boxdata.m_effortValues[ 0 ] / 252 ) ),
                    u8( 18 + 12 ), true, false, GRAY_IDX );
                ...
                for( int i = 1; i < 6; ++i ) {
                    ...
                    IO::printRectangle(
                        ...
                        u8( 26 + 6 + ( 17 * i ) ), true, false, GRAY_IDX );
                    IO::printRectangle(
