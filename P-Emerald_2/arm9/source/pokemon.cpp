        ...
        switch( p_page ) {
            case 0:
                ...
                if( !( m_boxdata.m_individualValues.m_isEgg ) ) {
                    ...
                    if( NatMod[ m_boxdata.getNature( ) ][ 0 ] == 1.1 )
                        cust_font.setColor( 254, 1 );
                    else if( NatMod[ m_boxdata.getNature( ) ][ 0 ] == 0.9 )
                        cust_font.setColor( 255, 1 );
                    else
                        cust_font.setColor( 251, 1 );
                    ...
                    if( NatMod[ m_boxdata.getNature( ) ][ 1 ] == 1.1 )
                        cust_font.setColor( 254, 1 );
                    else if( NatMod[ m_boxdata.getNature( ) ][ 1 ] == 0.9 )
                        cust_font.setColor( 255, 1 );
                    else
                        cust_font.setColor( 251, 1 );
                    ...
                    if( NatMod[ m_boxdata.getNature( ) ][ 3 ] == 1.1 )
                        cust_font.setColor( 254, 1 );
                    else if( NatMod[ m_boxdata.getNature( ) ][ 3 ] == 0.9 )
                        cust_font.setColor( 255, 1 );
                    else
                        cust_font.setColor( 251, 1 );
                    ...
                    if( NatMod[ m_boxdata.getNature( ) ][ 4 ] == 1.1 )
                        cust_font.setColor( 254, 1 );
                    else if( NatMod[ m_boxdata.getNature( ) ][ 4 ] == 0.9 )
                        cust_font.setColor( 255, 1 );
                    else
                        cust_font.setColor( 251, 1 );
                    ...
                    if( NatMod[ m_boxdata.getNature( ) ][ 2 ] == 1.1 )
                        cust_font.setColor( 254, 1 );
                    else if( NatMod[ m_boxdata.getNature( ) ][ 2 ] == 0.9 )
                        cust_font.setColor( 255, 1 );
                    else
                        cust_font.setColor( 251, 1 );
                    ...
                    FONT::putrec( (u8)158, u8( 46 + 6 ), u8( 158 + ( 68.0*m_boxdata.m_effortValues[ 0 ] / 252 ) ), u8( 46 + 12 ), false, false, u8( 7 * 16 - 1 ) );
                    ...
                    for( int i = 1; i < 6; ++i ) {
                        ...
                        FONT::putrec( (u8)158, u8( 54 + 6 + ( 17 * i ) ), u8( 158 + ( 68.0*m_boxdata.m_effortValues[ i ] / 252 ) ), u8( 54 + 12 + ( 17 * i ) ), false, false, u8( ( 7 + i ) * 16 - 1 ) );
                    }
                } else {
                    consoleSetWindow( p_top, 16, 4, 32, 24 );
